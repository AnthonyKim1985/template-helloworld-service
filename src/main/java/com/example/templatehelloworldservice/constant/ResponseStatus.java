package com.example.templatehelloworldservice.constant;
...
public enum ResponseStatus {
     ...
     */
    OK(2000, "SUCCESS"),
    OK_TOKEN_ISSUED(2001, "The token has been issued successfully."),
    ...
    BAD_REQUEST_UNAUTHORIZED(4001, "The unauthorized user cannot be accessible."),
